...
import editProduct from "../../Hooks/ProductControl/EditProduct";
...
function EditProduct() {
    ...
    const [inputText, setInputText, initialValue, saveHighlightArray, deleteHighlight, saveYoutubeLink, deleteYoutubeLink,onEditClickHighLight,onEditClickYoutube] =
        inputFieldHook();

  useEffect(()=>{
    if (state != null) {
        const { _id, name, price, highlightText, description, youtubeLinks, category, brandName, images } = state
        const value = {
            id: _id,
            highLightTextArray: highlightText,
            youtubeLinkArray: youtubeLinks,
            brandName: brandName,
    ...
    const[updateProductFun]=editProduct(inputText)
    ...
    return (
     ...
     text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-blue-200 from-sky-300"> Edit Product </span> </h1>
